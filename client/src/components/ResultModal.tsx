...
export default function ResultModal({ handleClose, open }: ResultModalProps) {
    ...
    <div className={`fixed z-40 w-full h-screen bg-black bg-opacity-40 flex justify-center items-center ${open ? 'scale-100' : 'scale-0'}`}>
      <div className={`bg-white rounded-lg w-[90%] md:w-[22rem] py-3 px-4 text-gray-800 border-t-8 border-emerald-400 transition-all duration-200 ${open ? 'scale-100' : 'scale-0'}`}>
        ...
        <div className="flex justify-center items-center mt-5 flex-col">
          <img src="https://quickchart.io/qr?text=https%3A%2F%2Fgithub.com&size=200&centerImageUrl=https%3A%2F%2Fi.imgur.com%2FRTuqNb2.png" alt="" />
          <div className="w-full h-0 border border-gray-200 my-5 mx-20"></div>
          <input type="url" value="https://example.com/Urm28d" className ="outline-none border-none py-3 px-4 rounded-lg w-full md:py-4 text-emerald-400 ring-1 ring-emerald-400" disabled />
          <div className="mt-7 mb-4 w-full space-y-4">
            <div className="grid grid-cols-2 space-x-2">
            <button className="bg-emerald-400 py-3 px-4 text-white rounded-lg hover:bg-emerald-400/90 transition-all duration-300 flex justify-center items-center flex-row space-x-2">
            ...
            <button className="bg-gray-800 py-3 px-4 w-full text-white rounded-lg hover:bg-gray-800/90 transition-all duration-300 flex justify-center items-center flex-row space-x-2">
